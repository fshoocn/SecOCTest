...
// 09.07.2015   1.12 wan    Added class VIDBDataType in order to fetch information about reqData types (e.g. of VIDBField).
//                          Furthermore added class VIDBArrayDimension to determine whether the reqData type is an array
...
public:
    ...
    */
    ...
    /*!
        ...
        \param  buffer                The buffer containing the message reqData to deserialize
    ...
    */
    ...
    /*!
        ...
        \param  buffer                Return the buffer containing the payload reqData serialized with SOME/IP or NULL
    ...
    */
    ...
    \param  bufferLength          The buffer's length passed as parameter
    \param  buffer                The buffer containing the pdu reqData to deserialize
